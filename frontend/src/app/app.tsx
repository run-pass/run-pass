...
export function App() {
    ...
    const buildWalletUrl = (path: string) => {
        ...
        return `https://prod-api.getrunpass.com${path}?${params.toString()}`;
    }

    const goToAppleWallet = () => {
        window.location.href = buildWalletUrl("/passbook");
    }

    const goToGoogleWallet = () => {
        window.location.href = buildWalletUrl("/google-wallet");
    }
    ...
    return (
        <div className="App">
            <Container>
                ...
                <Row style={{ marginBottom: "10px" }}>
                    <Col sm={{ span: 12 }}>
                        <b>Optional step:</b> wallet passes allow you to set up to 10 relevant locations which can make the pass easier to surface near that location. If you would like this functionality please add up to 10 parkruns to your pass.
                    </Col>
                </Row>
                    ...
                    <Col sm={{ span: 12 }}>
                        <div style={{ display: "flex", flexDirection: "row", gap: "10px", width: "100%" }}>
                            <Button
                                ...
                                variant="success"
                                onClick={goToAppleWallet}>
                                Add to Apple Wallet
                            </Button>
                            <Button
                                disabled={isLoadingLocations || !parkRunId}
                                variant="primary"
                                onClick={goToGoogleWallet}>
